...
async def health():
    try:
        ...
        raise HTTPException(status_code=503, detail={"status": "error", "service": "user-service", "mongo": "unavailable"}) from exc
    return {"status": "ok", "service": "user-service", "dependencies": {"mongo": "ok"}}
